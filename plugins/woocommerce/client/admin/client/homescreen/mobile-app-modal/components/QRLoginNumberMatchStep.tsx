...
export const QRLoginNumberMatchStep = ( {
	...
	return (
		<div
			className="qr-direct-login qr-direct-login--number-match"
			role="group"
			aria-label={ __( 'Confirm sign-in', 'woocommerce' ) }
		>
			<p className="qr-direct-login__match-headline">{ headline }</p>
			<p className="qr-direct-login__match-description">
				{ __(
			...
			<div
				className="qr-direct-login__number-tiles"
				role="group"
				...
				{ numbers.map( ( candidate, index ) => {
					...
					return (
						<Button
							key={ `${ candidate }-${ index }` }
							variant="secondary"
							className="qr-direct-login__number-tile"
			...
			<p className="qr-direct-login__match-countdown" aria-live="polite">
				{ expired
			...
			<div className="qr-direct-login__match-cancel-row">
				<p className="qr-direct-login__match-cancel-text">
					{ __( "I don't recognise this device", 'woocommerce' ) }
				</p>
				<Button
					variant="secondary"
					className="qr-direct-login__match-cancel-button"
					disabled={ inFlight }
					onClick={ () => {
						recordEvent(
